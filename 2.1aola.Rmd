...
I2=I[Casos1w$SINTOMAS_DIAGNOSTICO=="Síntomas leves"]
I3=I[Casos1w$SINTOMAS_DIAGNOSTICO=="Neumonía"]
...
* Contrastes posteriores de edades gestacionales medias por parejas:  tests de Mann-Whitney,p-valores ajustados por Bonferroni:
    ...
    * Asintomáticas vs Síntomas leves: $`r signif(pairwise.wilcox.test(I,Sint,p.adjust.method = "bonferroni")$p.value[1,1],1)`$
